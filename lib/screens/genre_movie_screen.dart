...
class GenreMovieScreenWidget extends StatefulWidget {
  ...
  const GenreMovieScreenWidget({super.key, required this.genreName, required this.genreIds});
...
class _GenreMovieScreenWidgetState extends State<GenreMovieScreenWidget> {
  ...
  Future<void> _loadMovies() async {
    ...
    try {
      final movies = await _tmdbService.fetchMoviesByGenre(widget.genreIds);
      if (!mounted) return;
      setState(() {
        _movies = movies
